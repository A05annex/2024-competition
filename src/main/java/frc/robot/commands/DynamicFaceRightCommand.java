...
public class DynamicFaceRightCommand extends A05DriveCommand {

    public DynamicFaceRightCommand() {
    ...
    public void execute() {
        ...
        double heading = NetworkTableInstance.getDefault().getTable("FMSInfo").getEntry("IsRedAlliance").getBoolean(true) ? 90 : 60;
